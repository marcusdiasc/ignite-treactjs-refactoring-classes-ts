...
import { Food as FoodType } from "../../types/types";
...
function Dashboard() {
  ...
  async function handleAddFood(food: Partial<FoodType>) {
    try {
  ...
  async function handleUpdateFood(food: Partial<FoodType>) {
    try {
